...
function BandCardName(props) {
  ...
  return (
    <a href="#" className="font-title link font-bold">
      {children}
    </a>
  );
}
...
function BandCardNumberOfListeners(props) {
  ...
  return (
    <span className="text-gray font-text">
      {children}
    </span>
  );
}
...
function BandCardMoreInfoTitle(props) {
  ...
  return (
    <span className="text-gray font-text font-bold text-uppercase">
      {children}
    </span>
  );
}
...
function BandCardMoreInfoDescription(props) {
  ...
  return (
    <span className="text-gray font-text font-bold">
      {children}
    </span>
  );
}
